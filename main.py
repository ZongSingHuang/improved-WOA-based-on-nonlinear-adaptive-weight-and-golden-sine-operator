...
for t in range(run_times):
    ...
    optimizer = NGS_WOA(fitness=benchmark.Sphere,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Rastrigin,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Ackley,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Griewank,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Rosenbrock,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Quartic,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Penalized1,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Penalized2,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Schwefel_226,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Step,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Kowalik,
    ...
    optimizer = NGS_WOA(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = NGS_WOA(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = NGS_WOA(fitness=Shekel5,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Branin,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = NGS_WOA(fitness=Shekel7,
                        D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = NGS_WOA(fitness=benchmark.Shekel,
                    D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = NGS_WOA(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Hartmann6,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Zakharov,
    ...
    optimizer = NGS_WOA(fitness=benchmark.SumSquares,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Alpine,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Michalewicz,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Exponential,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Schaffer,
    ...
    optimizer = NGS_WOA(fitness=benchmark.BentCigar,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Elliptic,
    ...
    optimizer = NGS_WOA(fitness=benchmark.DropWave,
    ...
    optimizer = NGS_WOA(fitness=benchmark.CosineMixture,
    ...
    optimizer = NGS_WOA(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = NGS_WOA(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(NGS_WOA).csv')
...
table.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                 ...
                 'Bohachevsky 1', 'Elliptic', 'Drop Wave', 'Cosine Mixture', 'Ellipsoidal',
                 'Levy and Montalvo 1']
table.to_csv('table(NGS_WOA).csv')